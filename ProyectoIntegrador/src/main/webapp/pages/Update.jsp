...
<%
	...
	while(rsId.next()) {
		...
		String query = "UPDATE `tickets` SET `nombre`='"+nombre+"',`apellido`='"+apellido+"',`email`='"+email+"',`cantidad`='"+cantidad+"',`categoria`='"+categoria+"' WHERE id = "+idNum+" "; //genera la consulta y busca el valor con el que vamos a trabajar
